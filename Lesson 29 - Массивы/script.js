...
// | --------- | -------------------- | ----------------- |
// | `forEach` | перебор              | ничего            |
// | `map`     | изменить элементы    | новый массив      |
// | `filter`  | оставить нужные      | новый массив      |
// | `find`    | найти один           | элемент           |
// | `some`    | есть ли хотя бы один | boolean           |
// | `every`   | все ли подходят      | boolean           |
// | `reduce`  | собрать в одно       | любое значение    |
// | `sort`    | сортировка           | массив            |
// | `push`    | добавить в конец     | длину массива     |
// | `pop`     | удалить конец        | удалённый элемент |
// | `shift`   | удалить начало       | удалённый элемент |
// | `unshift` | добавить начало      | длину массива     |
// | `splice`  | удалить/вставить     | изменённый массив |
